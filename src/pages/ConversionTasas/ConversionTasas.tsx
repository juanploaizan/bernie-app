...
import Number1Icon from '../../images/numbers/number-1.svg';
...
const ConversionTasas = () => {
  ...
  const handleSubmit = (event: FormEvent) => {
    ...
    if (true) {
      ...
      //let resultado = valorFuturo / (1 + tasa * periodo);
      /*
  ...
  return (
    <DefaultLayout>
      ...
      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div>
          <h3 className="mx-6.5 -mb-3 mt-7.5 text-xl font-semibold text-black dark:text-white">
            Interés actual
          </h3>
        </div>
          ...
          <div className="p-6.5">
            <div>
              ...
              <div className="relative z-20 bg-white dark:bg-form-input">
                <select className="relative z-20 w-full appearance-none rounded border border-stroke bg-transparent py-3 pl-5 outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input">
                  <option value="">Anticipado</option>
            ...
            <button
              ...
              className="mt-5.5 flex w-full justify-center rounded bg-primary p-3 font-medium text-gray"
            >
              Convertir
            </button>
          </div>
