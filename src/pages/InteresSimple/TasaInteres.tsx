...
const TasaInteres = () => {
  ...
  const handleSubmit = (event: FormEvent) => {
    ...
    if (valorFuturo > 0 && periodo > 0 && valorPresente > 0) {
      setWarningNotification(false);

      let resultado = (valorFuturo - valorPresente) / (valorPresente * periodo);

      setNotificationMessage(
        resultado <= 0
          ? 'El resultado es menor o igual a cero. Asegúrate de diligenciar correctamente los campos'
          : 'La tasa de interés, utilizando interés simple, es de ' +
  ...
  return (
    <DefaultLayout>
      <Breadcrumb pageName="Interés simple" />
